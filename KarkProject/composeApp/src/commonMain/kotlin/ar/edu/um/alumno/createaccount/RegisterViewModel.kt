...
class RegisterViewModel : ViewModel() {
    ...
    fun onRegisterChanged(login: String, email: String, password: String, nombres: String, descripcion: String) {
        _login.value = login
        _email.value = email
        _password.value = password
        _nombres.value = nombres
        _descripcion.value = descripcion
        _registerEnable.value = isValidEmail(email) && isValidPassword(password) && login.isNotEmpty() && nombres.isNotEmpty() && descripcion.isNotEmpty()
    }
